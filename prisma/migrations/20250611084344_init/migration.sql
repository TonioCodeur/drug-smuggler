...
-- CreateIndex
CREATE UNIQUE INDEX "DrugType_name_key" ON "DrugType"("name");
...
-- AddForeignKey
ALTER TABLE "Drug" ADD CONSTRAINT "Drug_drugTypeId_fkey" FOREIGN KEY ("drugTypeId") REFERENCES "DrugType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Hideout" ADD CONSTRAINT "Hideout_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
